...
snapshots, and intelligent comparisons of Excel workbooks at the sheet
level. Designed for audit trails, regulatory compliance, data pipelines,
and version control workflows.

## Features

- **Sheet-level fingerprinting** using cryptographic hashes (SHA-256
  recommended)
...
- **S3 object system** (`excel_book` and `excel_sheet`) for clean
  handling of workbooks
